...
namespace StratifiedEventQueue.Processes.Gates
{
    ...
    {
        /// <summary>
        /// Gets the first input of the Xor-gate.
        /// </summary>
        public IState<Signal> A { get; }

        /// <summary>
        /// Gets the second input of the Xor-gate.
        /// </summary>
        public IState<Signal> B { get; }

        /// <summary>
        /// Creates a new <see cref="Xor"/> gate.
        /// </summary>
        ...
        public Xor(string name, Driver output, IState<Signal> a, IState<Signal> b,
