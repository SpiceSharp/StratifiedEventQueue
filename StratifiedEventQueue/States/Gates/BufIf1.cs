...
namespace StratifiedEventQueue.States.Gates
{
    ...
    /// An bufif1 gate.
    /// </summary>
    public class BufIf1 : TriGate
    {
        /// <summary>
        /// Gets the data input of the BufIf1-gate.
        /// </summary>
        public IState<Signal> Data { get; }

        /// <summary>
        /// Gets the control input of the BufIf1-gate.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="BufIf1"/> gate.
        /// </summary>
        ...
        public BufIf1(string name, string outputName, IState<Signal> data, IState<Signal> control,
            Func<uint> riseDelay = null, Func<uint> fallDelay = null, Strength low = Strength.St0, Strength high = Strength.St1)
        ...
        public override string ToString() => $"bufif1 {GateName}";
    }
}
