...
namespace StratifiedEventQueue.States.Gates
{
    ...
    /// An notif0 gate.
    /// </summary>
    public class NotIf0 : TriGate
    {
        /// <summary>
        /// Gets the data input of the NotIf0-gate.
        /// </summary>
        public IState<Signal> Data { get; }

        /// <summary>
        /// Gets the control input of the NotIf0-gate.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="NotIf0"/> gate.
        /// </summary>
        ...
        public NotIf0(string name, string outputName, IState<Signal> data, IState<Signal> control,
        ...
        public override string ToString() => $"notif0 {GateName}";
    }
}
