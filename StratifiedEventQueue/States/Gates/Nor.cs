...
namespace StratifiedEventQueue.States.Gates
{
    ...
    {
        /// <summary>
        /// Gets the first input of the Nor-gate.
        /// </summary>
        public IState<Signal> A { get; }

        /// <summary>
        /// Gets the second input of the Nor-gate.
        /// </summary>
        public IState<Signal> B { get; }

        /// <summary>
        /// Creates a new <see cref="Nor"/> gate.
        /// </summary>
        ...
        public Nor(string name, string outputName, IState<Signal> a, IState<Signal> b,
        ...
        protected override Signal ComputeSignal()
            => LogicHelper.Nor(A.Value, B.Value);
